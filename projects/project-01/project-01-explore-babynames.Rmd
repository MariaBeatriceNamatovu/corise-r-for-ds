...
tbl_names_popular |> 
  ...
  labs(
    ...
    subtitle = 'Extracted from the decade',
    caption = 'from 2011 to 2020',
    x = 'nb_births',
    y = 'name'
  ) +
...
tbl_names = tbl_names |> 
  ...
  set(last_letter = str_to_upper(last_letter))
...
plot_trends_in_letter <- function(my_letter) {
  tbl_names_by_letter |> 
    ...
    labs(
      ...
      subtitle = "trend is expressed in percentage",
      caption = "the first letter is random",
      x = "Names starting with a specific letter",
